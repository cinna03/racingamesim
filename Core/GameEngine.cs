...
namespace TimeBasedRacingGame.Core
{
    ...
    public class GameEngine
    {
        ...
        public GameEngine(double maxTime = 300)
        {
            ...
            {
                new Vehicle(VehicleType.SportsVehicle, "NEON STRIKER", 120, 8.0, 60),
                new Vehicle(VehicleType.EcoVehicle, "CYBER CRUISER", 80, 4.0, 80),
                new Vehicle(VehicleType.RacingVehicle, "PLASMA PHANTOM", 150, 12.0, 50)
            };
        }
